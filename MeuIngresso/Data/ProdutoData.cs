...
namespace MeuIngresso.Data
{
    public class ProdutoData : Data
    {
        public void Create(Produto produto)
        {
            ...
            comandoSql.CommandText = @"INSERT INTO Produtos (nome, descricao, valor, tipo_De_Show) values(@nome, @descricao, @valor, @tipo_De_Show)";
        ...
        public List<Produto> Read()
        {
            ...
            try
            {
                ...
                comandoSql.Connection = base.conexaoDB;
                comandoSql.CommandText = @"SELECT * FROM Produtos ORDER BY nome ASC";
                ...
                while (dadosSql.Read())
                {
                    ...
                    produto.Valor = (decimal)dadosSql["valor"];
        ...
        public Produto Read(int idProduto)
        {
            ...
            try
            {
                ...
                comandoSql.Connection = base.conexaoDB;
                comandoSql.CommandText = @"SELECT * FROM Produtos WHERE idProduto = @id";
        ...
        public void Update(Produto produto)
        {
            try
            {
                ...
                comandoSql.CommandText = @"UPDATE Produtos SET nome = @nome, descricao = @descricao, valor = @valor, tipo_De_Show = @tipo_De_Show WHERE idProduto = @idProduto";
